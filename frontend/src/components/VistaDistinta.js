        ...
        if (vistaActual === 'inicio') {
            return (
                <div className="menu-botones">
                    ...
                    <button onClick={() => setVistaActual('pendienteRetiro')} className="boton-vista">Reparaciones a Retirar</button>
    ...
    return (
        <div className="vista-administrador">
            ...
            <div className="vista-actual">
                ...
                {vistaActual === 'pendienteRetiro' && <PendienteRetiro volver={volverAInicio} />}
